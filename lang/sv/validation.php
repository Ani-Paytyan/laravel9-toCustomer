...
return [
    ...
    'doesnt_end_with' => ':Attributet får inte sluta med något av följande: :värden.',
    'doesnt_start_with' => ':Attributet får inte börja med något av följande: :värden.',
    ...
    'max_digits' => ':Attributet får inte ha fler än :max siffror.',
    ...
    'min_digits' => ':Attributet måste ha minst :min-siffror.',
    ...
    */
    ...
    'phone' => 'Fältet telefon är obligatoriskt.',
    'form' => 'Detta formulär är inte tillgängligt.',
    'token' => 'Denna lösenordsåterställningstoken är ogiltig.',

    'message' => 'De angivna uppgifterna var ogiltiga.',
    /*
    |--------------------------------------------------------------------------
